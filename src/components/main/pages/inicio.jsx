...
function Inicio() {
  return (
    <>
      <div className="bg-gradient-to-bl from-purple to-black-300 h-screen rounded-xl relative p-3 col-start-1 row-start-2 sm:col-start-2 sm:row-start-1 lg:col-span-4 lg:col-start-4 overflow-auto scroll">
