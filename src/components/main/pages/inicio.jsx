...
function Inicio() {
  return (
    <>
      <div className="bg-gradient-to-bl from-purple to-black-300 h-screen rounded-xl relative p-3 col-start-1 row-start-1 sm:col-start-2 sm:row-start-1 lg:col-span-5 lg:col-start-3 overflow-auto scroll">
        <Start />
        <section className="py-16 px-4 sm:p-6 md:px-8 m-auto">
          <div className="max-w-4xl lg:max-w-5xl mx-auto">
            ...
            student-led design studio, and a huge corporation. <br /> <br /> My
            main focus these days is building products and leading projects for
            ...
            know to build a web app with the Spotify API. <br />
