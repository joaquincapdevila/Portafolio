    ...
    <div className="relative isolate dark:text-white t-16 px-4 sm:p-6 md:px-8 mx-auto">
      <div className="max-w-4xl lg:max-w-5xl mx-auto overflow-hidden">
        <div className="grid gap-3">
          {/* IMAGEN */}
          <div className="max-w-fit sm:shrink-0 h-48 w-48 overflow-hidden rounded-xl bg-gradient-to-br from-dark-blue via-midnight to-purple row-start-1">
          ...
          {/* TEXTO */}
          <div className="text-sm grid gap-3 row-start-3 sm:col-span-5 max-w-fit min-w-max">
