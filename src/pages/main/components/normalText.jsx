  ...
  return (
    <section className="max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl dark:text-white rounded-xl px-5 py-7  transition-colors bg-white/5 hover:bg-white/10 shadow-md">
      ...
      <p className="mb-3 text-gray-500 dark:text-gray-400">
        ...
        lado del cliente. Disfruto explorando nuevas funcionalidades y patrones
        de diseño que estas bibliotecas ofrecen para mejorar la experiencia del
        usuario.
      </p>
      <p className="text-gray-500 dark:text-gray-400">
        Mi enfoque es simplificar el proceso de creación desde el diseño hasta
        el despliege a producción. Acelerando el desarrollo crítico, eliminando
        tareas repetitivas y facilitando la implementación de cambios. Cada
        modificación cuenta con un registro.
      </p>
    </section>
  );
};
